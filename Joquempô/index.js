...
const $papersButton2 = document.querySelector(".button-paper-player-2");
...
function verifyGame() {
  /* se movPlayer1 = 'stone' e movePlayer 2 =  'paper' > jogadora 2 ganhou */
...
function printScoreboard() {
  if (scorePlayer1 < 10) {
    $scorePlayer1.innerHTML = scorePlayer1 = "0" + scorePlayer1;
  } else {
...
function move(moveName, fieldNumber) {
  if (gameStart) {
    ...
    //  '<img class="move-image" src="'+ VARIAVEL +'.png">'
...
$papersButton2.addEventListener("click", function () {
  move("paper", 2);
});
